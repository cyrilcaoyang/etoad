...
class ERROR(Enum):
    ...
    INSTR_TOOMANYDATA = -102  # "Too many data to transfer from the instrument (device error)"
    ...
    FIRM_FIRMWAREINCOMPATIBLE = -309  # "Loaded firmware not compatible with the library"
